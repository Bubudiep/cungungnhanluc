    ...
    <div className="w-full overflow-auto scroll-smooth">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
              ...
              <div className="pb-6 px-6">
                <h4 className="text-xl font-bold mb-2">Phân tích & Báo cáo</h4>
                <p>
                  Cung cấp báo cáo chi tiết, hỗ trợ ra quyết định nhanh chóng và
                  chính xác.
                </p>
              </div>
            </div>
      ...
      <section id="about" className="py-20 bg-white fadeIn-up">
        <div className="container mx-auto text-center">
          ...
          <p>
            Chúng tôi là đội ngũ chuyên gia công nghệ cung cấp các giải pháp số
            giúp doanh nghiệp Việt Nam hiện đại hoá và phát triển bền vững trong
            kỷ nguyên 4.0.
          </p>
        </div>
      </section>
      <section id="contact" className="py-20 bg-[#008cff] text-white fadeIn-up">
        <div className="container mx-auto text-center">
          <h3 className="text-3xl font-semibold mb-6">Liên hệ với chúng tôi</h3>
          <p>
